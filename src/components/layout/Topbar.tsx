  ...
  return (
    ...
    >
      <div style={{ flex: 1, minWidth: 0 }}>
        <h1 style={{ fontSize: 19, fontWeight: 700, color: 'var(--text-strong)', letterSpacing: '-0.02em', lineHeight: 1.1 }}>{title}</h1>
      ...
      >
        ...
        <input
          ...
          style={{ flex: 1, border: 'none', outline: 'none', background: 'transparent', fontFamily: 'var(--font-sans)', fontSize: 13, color: 'var(--text-body)', minWidth: 0 }}
        />
      </div>
      ...
      <div style={{ position: 'relative' }} className="gx-no-print">
